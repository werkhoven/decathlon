function [data,fn] = getDataFields_abshand(expmt,trackProps)
    ...
    switch expmt.Name
        ...
        case 'Arena Circling'
            ...
            data.r = nanmean(trackProps.r);
            data.direction = nanmean(trackProps.direction);
            data.turning = nanmean(trackProps.turning);
            data.theta = nanmean(trackProps.theta);
            data.r(data.r==0)=NaN;
            data.direction(data.direction==0)=NaN;
        ...
        case 'Y-maze'     
            ...
            data.r = nanmean(trackProps.r(:,idx));
            data.direction = nanmean(trackProps.direction(:,idx));
            data.turning = nanmean(trackProps.turning(:,idx));
            data.theta = nanmean(trackProps.theta(:,idx));
            data.r(data.r==0)=NaN;
            data.direction(data.direction==0)=NaN;
            data.theta(data.theta==0)=NaN;
